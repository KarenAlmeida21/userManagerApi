...
public class FiltroDeAutorizacaoJWT extends BasicAuthenticationFilter {
    ...
    public UsernamePasswordAuthenticationToken pegarAutenticacao(String token){
        ...
        UserDetails userLogado = userDetailsService.loadUserByUsername(claims.getSubject());

        return new UsernamePasswordAuthenticationToken(userLogado, null, userLogado.getAuthorities());
    }
